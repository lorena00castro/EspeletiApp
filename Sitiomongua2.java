...
public class Sitiomongua2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sitiomongua2);
        ...
        atras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Sitiomongua2.this,Mongua.class);
        ...
        imagen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sitiomongua2.this,GaleriaMongua1.class);
                startActivity(intent);
            }
        });
    }
