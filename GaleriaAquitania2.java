...
public class GaleriaAquitania2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galeria_aquitania2);
    ...
    {
        Intent imagen = new Intent(GaleriaAquitania2.this,ImagenSeleccionada.class);
