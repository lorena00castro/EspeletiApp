...
public class Sitioaquitania1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sitio_aquitania1);
        ...
        atras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Sitioaquitania1.this,Aquitania.class);
        ...
        imagen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sitioaquitania1.this,GaleriaAquitania1.class);
                startActivity(intent);
            }
        });
    }
