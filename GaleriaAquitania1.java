...
public class GaleriaAquitania1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galeria_aquitania1);
    ...
    {
        Intent imagen = new Intent(GaleriaAquitania1.this,ImagenSeleccionada.class);
