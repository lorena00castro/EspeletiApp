...
public class GaleriaMongui2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galeria_mongui2);
    ...
    {
        Intent imagen = new Intent(GaleriaMongui2.this,ImagenSeleccionada.class);
