...
public class GaleriaAquitania3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galeria_aquitania3);
    ...
    {
        Intent imagen = new Intent(GaleriaAquitania3.this,ImagenSeleccionada.class);
