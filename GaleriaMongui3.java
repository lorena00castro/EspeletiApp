...
public class GaleriaMongui3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galeria_mongui3);
    ...
    {
        Intent imagen = new Intent(GaleriaMongui3.this,ImagenSeleccionada.class);
