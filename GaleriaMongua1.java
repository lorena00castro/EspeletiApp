...
public class GaleriaMongua1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galeria_mongua1);
    ...
    {
        Intent imagen = new Intent(GaleriaMongua1.this,ImagenSeleccionada.class);
